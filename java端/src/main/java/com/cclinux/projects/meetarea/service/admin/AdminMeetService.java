package com.cclinux.projects.meetarea.service.admin;
...
import com.cclinux.projects.meetarea.comm.ProjectConfig;
...
import com.cclinux.projects.meetarea.service.cust.MeetService;
...
@Service("MeetAreaAdminMeetService")
public class AdminMeetService extends BaseMyAdminService {
    ...
    @Resource(name = "MeetAreaMeetService")
    ...
    public long insertMeet(MeetModel meet) {
        appError("{小区}该功能暂不开放，如有需要请加作者微信：cclinux0730");
