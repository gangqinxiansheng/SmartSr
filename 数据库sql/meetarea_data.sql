...
-- ----------------------------
-- Table structure for meetarea_admin
-- ----------------------------
DROP TABLE IF EXISTS `meetarea_admin`;
CREATE TABLE `meetarea_admin`  (
...
INSERT INTO `meetarea_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 0, 0, 0);

-- ----------------------------
-- Table structure for meetarea_fav
-- ----------------------------
DROP TABLE IF EXISTS `meetarea_fav`;
CREATE TABLE `meetarea_fav`  (
...
-- ----------------------------
-- Table structure for meetarea_meet
-- ----------------------------
DROP TABLE IF EXISTS `meetarea_meet`;
CREATE TABLE `meetarea_meet`  (
...
-- ----------------------------
-- Table structure for meetarea_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meetarea_meet_join`;
CREATE TABLE `meetarea_meet_join`  (
...
-- ----------------------------
-- Table structure for meetarea_news
-- ----------------------------
DROP TABLE IF EXISTS `meetarea_news`;
CREATE TABLE `meetarea_news`  (
...
-- ----------------------------
-- Table structure for meetarea_setup
-- ----------------------------
DROP TABLE IF EXISTS `meetarea_setup`;
CREATE TABLE `meetarea_setup`  (
...
-- ----------------------------
-- Table structure for meetarea_user
-- ----------------------------
DROP TABLE IF EXISTS `meetarea_user`;
CREATE TABLE `meetarea_user`  (
